...
- **Documentation**: Guides, reference docs, and research in `wiki/`
...
3. Read [[Current-Status]] for full project context
...
| `wiki/` | Technical guides, reference docs, research, build history |
