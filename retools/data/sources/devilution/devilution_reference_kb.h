// Devilution reference knowledge base
// Source: https://github.com/diasurgical/devilution
// Compiler: MSVC 4.2 (Visual C++ 4.2)
// NOTE: Addresses are for DIABLO.EXE, not the current binary.
// Struct/enum definitions are portable across binaries.

// === Struct definitions (from Diablo 1 decomp) ===
