...
namespace comp
{
	...
	// LA Noire registers WNDCLASSEXA.lpszClassName = "L.A. Noire"
	// (ASCII @ VA 0x011926b8 in LANoire.exe; RegisterClassExA call site VA 0x009f1699).
	// Substring-contains match below; "L.A. Noire" is also the window title.
	#define WINDOW_CLASS_NAME "L.A. Noire"
