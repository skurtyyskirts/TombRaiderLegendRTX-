...
if not defined VSDIR if exist "C:\Program Files\Microsoft Visual Studio\18\Community\VC\Auxiliary\Build\vcvarsall.bat" set VSDIR=C:\Program Files\Microsoft Visual Studio\18\Community
